...
public class DirectRouteBuilder extends AbstractSystemOneRouteBuilder {
	...
	public void configure() throws Exception {
		...
		from("direct:hl7Main")
			...
			.to("rabbitmq://localhost:5672/adtxx.in?queue=adtxx.out&automaticRecoveryEnabled=true&autoDelete=false&durable=true&connectionFactory=#rabbitMQConnectionFactory")
